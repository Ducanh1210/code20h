<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center gap-2">
            <span class="material-symbols-outlined text-sky-500">add_circle</span>
            <span>Thêm Job Description mới</span>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div class="glass-card rounded-[2.5rem] shadow-sm border border-white overflow-hidden p-10">
            <div class="mb-10">
                <h3 class="text-2xl font-black text-slate-900 tracking-tight">Mô tả công việc</h3>
                <p class="text-sm text-slate-400 font-medium">Cung cấp các thông tin chi tiết về vị trí tuyển dụng.</p>
            </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <textarea name="description" id="description" rows="6"
                            ...
                            placeholder="Nhập mô tả chi tiết về công việc, trách nhiệm, môi trường làm việc...">{{ old('description') }}</textarea>
                    </div>
