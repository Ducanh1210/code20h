...
class CvController extends Controller
{
    ...
    public function storeWithTemplate(Request $request)
    {
        ...
        // Initialize content based on template ID
        $content = [
            'header' => [
                'name' => Auth::user()->name,
                'job_title' => 'Vị trí mong muốn',
            ...
            'settings' => [
                'theme' => $request->base_color ?? 'indigo',
        ...
        if ($request->template_id === 'classic_prof') {
            $content['sections'] = [
                ['id' => 'obj', 'title' => 'Mục tiêu nghề nghiệp', 'type' => 'text', 'content' => 'Nhập mục tiêu...'],
                ['id' => 'exp', 'title' => 'Kinh nghiệm', 'type' => 'list', 'items' => [['title' => 'Công ty A', 'subtitle' => 'Web Dev', 'date' => '2023 - Nay', 'description' => '...']]],
                ['id' => 'edu', 'title' => 'Học vấn', 'type' => 'list', 'items' => [['title' => 'Đại học B', 'subtitle' => 'CNTT', 'date' => '2019 - 2023', 'description' => '...']]],
            ];
        } else {
            // Default Modern structure
            $content['sections'] = [
                ['id' => 'objective', 'title' => 'Lời giới thiệu', 'type' => 'text', 'content' => 'Tóm tắt kỹ năng bản thân...'],
                ['id' => 'experience', 'title' => 'Quá trình làm việc', 'type' => 'list', 'items' => [['title' => 'Công ty X', 'subtitle' => 'Designer', 'date' => '2022', 'description' => '...']]],
                ['id' => 'skills', 'title' => 'Kỹ năng', 'type' => 'text', 'content' => '- PHP, Laravel, Tailwind...'],
            ];
        }
